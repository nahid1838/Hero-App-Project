...
const Navbar = () => {
    ...
    const navItems = [
        ...
        { label: "Installation", href: "/instalation" },
    ];
                ...
                return (
                    <li key={item.href}>
                        <Link
                            ...
                            className={
                                isActive
                                    ? "text-blue-600 font-semibold border border-blue-600 px-3 py-1"
                                    : "text-gray-700"
                            }
                        >
                            {item.label}
    ...
    <div className="bg-base-100 shadow-sm">
      <div className="navbar container mx-auto">
        ...
        <div className="navbar-end">
          <a href="https://github.com/nahid1838"
          className="btn bg-linear-to-r from-blue-500 to-purple-500 text-white">
